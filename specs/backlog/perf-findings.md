...
| F5  | open      | `shared/rpc.ts` `message_update` mirrors a **pre-0.84.0** pi; all `partial` handling is dead code     | high | VERIFIED against installed pi 0.84.2 + its CHANGELOG + `docs/rpc.md`           | `shared/rpc.ts:195-211,227`                                                                                                                                      |
